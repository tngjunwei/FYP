...
def default_hps():
  return HyperParams(num_steps=2000, # train model for 2000 steps.
                     max_seq_len=499, # train on sequences of 100
                     input_seq_width=vocab_size+action_size,    # width of our data (32 + 3 actions)
                     output_seq_width=vocab_size,    # width of our data is 32
