...
def default_hps():
  return HyperParams(num_steps=40000,
                     ...
                     input_seq_width=38,    # width of our data (32 + 3 actions)
...
initial_mu = np.copy(data_mu[:100, 0, :]*10000).astype(np.int).tolist()
initial_logvar = np.copy(data_logvar[:100, 0, :]*10000).astype(np.int).tolist()
