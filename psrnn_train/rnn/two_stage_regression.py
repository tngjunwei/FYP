...
def _two_stage_regression(raw_data, # initially is bag of words
                         data, #one-hot
...
def get_params(data, config, no_init=False):
    import pickle, os
    if not no_init and os.path.exists('./rnn/params.pickle'):
        with open('./rnn/params.pickle', 'rb') as f:
            return pickle.load(f)

    params = _two_stage_regression(
            data, # train_data
    ...
    with open('./rnn/params.pickle', 'wb') as f:
